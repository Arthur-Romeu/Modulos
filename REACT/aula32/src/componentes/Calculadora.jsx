...
function Calculadora(){
    ...
    return(
        <div>
            <input type="number" placeholder="Número1" id="num1" onChange={(e)=> handleChange(e,setNum1)}/>
            <input type="number" placeholder="Números2" id="num2" onChange={(e)=> handleChange(e,setNum2)}/>
            <input type="text" placeholder="Operação" id="operador" onChange={(e)=> handleChange(e,setOperador)}/>
